...
def read_yookassa_csv():
    """Читает CSV ЮKassa с разделителем ;"""
    ...
    try:
        ...
        # Парсим данные
        payments = []
        for line in lines[1:]:  # Пропускаем заголовки
            if not line.strip():
                continue
        ...
        print(f"✅ Прочитано {len(payments)} платежей")
        ...
        print(f"🎯 Статусы платежей: {status_counts}")
